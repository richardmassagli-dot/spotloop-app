...
export const SPOTLOOP_PRICING_PLANS = [
  ...
  },
  {
    ...
    price: "€49",
    period: "/ Monat",
    tagline: "Kernfunktionen — QR, Stempel, Reward, Übersicht",
    features: "QR · Stempelkarte · Reward · tägliche Übersicht",
    tier: "standard",
    campaignsPerWeek: 0,
    campaignsPerMonth: 0,
...
export const PLAN_FEATURE_BULLETS = {
  pilot: [
    ...
    "QR, Stempelkarte, Reward, Kampagnen, Stammgäste",
    "Wir freuen uns über ehrliches Feedback",
  ],
  starter: [
    "QR-Code (ausdrucken & aufstellen)",
    "Stempelkarte & Reward konfigurieren",
